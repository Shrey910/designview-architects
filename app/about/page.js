      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-neutral-600 text-justify leading-relaxed mb-4">
            With a legacy that began in 1997, Designview Architects has grown into Ahmedabad's most trusted names in architecture and interior design. With 25+ years of experience in the industry, we have consistently delivered innovative, functional, and emotionally engaging spaces across residential, commercial, and institutional sectors.
          </p>
          <p className="text-neutral-600 text-justify leading-relaxed mb-4">
        ...
        >
          <h2 className="text-3xl font-serif font-light mb-4 text-center">Our Approach</h2>
          <div className="flex flex-col md:flex-row items-start justify-between gap-4">
            <div className="text-center p-2 flex-1">
              ...
              <h3 className="text-xl font-serif font-light mb-2">Discover</h3>
            ...
            <div className="text-center p-2 flex-1">
              ...
              <h3 className="text-xl font-serif font-light mb-2">Design</h3>
              <p className="text-neutral-600 text-justify">
            ...
            <div className="text-center p-2 flex-1">
              ...
              <h3 className="text-xl font-serif font-light mb-2">Deliver</h3>
              <p className="text-neutral-600 text-justify">
          ...
          {/* Mobile indicators for step flow */}
          <div className="flex md:hidden justify-center mt-2 space-x-6">
